    ...
    public class MySql:DB
    {
        ...
        public override System.Data.DataTable ObterDados(string vtexto, System.Data.CommandType vtipo)
        {
            ...
            if (conexao.State == ConnectionState.Open)
            {
                ...
                adapter.SelectCommand = (MySqlCommand)vcomando;
                try
                {
                    adapter.Fill(tabela);
                    retorno = tabela;
        ...
        {
            int retorno = -1;
            MySqlCommand vcomando = new MySqlCommand(nome, (MySqlConnection)conexao);
        ...
        public override DataTable ExecutarProcedure(string nome, List<Parametros> parametros)
        {
            ...
            if (conexao.State == ConnectionState.Open)
            {
                try
                {
                    ...
                    DA = new MySqlDataAdapter(vcomando);
                    DA.Fill(DS);
        ...
        {
            MySqlParameter pparametro = new MySqlParameter();
