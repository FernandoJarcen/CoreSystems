...
namespace CoreFramework.Controles.Controle
{
    ...
    public partial class TabListExtends : Control
    {
        ...
        private TabListPageExtends[] _pages;
        ...
        public TabListExtends()
        {
            ...
            this.Font = new Font("Microsoft Sans Serif", 9F, FontStyle.Regular);
        ...
        public virtual TabListPageExtends HitTest(Point point)
        {
            int index;
        ...
        internal int AddPage(TabListPageExtends page)
        {
            int index;
        ...
        internal TabListPageExtends[] GetTabListPages()
        {
            TabListPageExtends[] copy;

            copy = new TabListPageExtends[this.TabListPageCount];
        ...
        internal int InsertPage(int index, TabListPageExtends page)
        {
            if (_pages == null)
                _pages = new TabListPageExtends[1];
            ...
            else if (_pages.Length == this.TabListPageCount)
            {
                ...
                copy = new TabListPageExtends[_pages.Length + 1];
        ...
        internal void UpdatePage(TabListPageExtends page)
        {
            this.Invalidate();
        }
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual TabListPageExtends SelectedPage
        {
        ...
        protected virtual void UpdatePages()
        {
            ...
            foreach (TabListPageExtends page in this.TabListPages)
            {
