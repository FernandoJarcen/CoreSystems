...
namespace CoreFramework.Controles.Controle
{
    public partial class DirectoryExtends : DesignControlBase
    {
        ...
        {
            fbd_action.Description = "Selecione uma pasta";
            fbd_action.RootFolder = Environment.SpecialFolder.MyComputer;
            fbd_action.ShowNewFolderButton = true;
            if (fbd_action.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                tbx_action.Text = fbd_action.SelectedPath;
            }
        }
