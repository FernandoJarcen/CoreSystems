...
namespace CoreFramework.Controles.Controle.Designer
{
    public class TabListDesigner : ParentControlDesigner
    {
        ...
        {
            return control is TabListExtends && !this.Control.Contains(control);
        }
        ...
        public override void Initialize(IComponent component)
        {
            ...
            control = component as TabListExtends;
            if (control != null)
        ...
        private TabListPageExtends GetComponentOwner(object component)
        {
            TabListPageExtends result;
            ...
            if (component is Control)
            {
                ...
                while (parent != null && !(parent is TabListPageExtends))
                    parent = parent.Parent;

                result = (TabListPageExtends)parent;
            }
            else
                result = null;
        ...
        {
            TabListPageDesigner designer;
            TabListPageExtends selectedPage;
        ...
        protected TabListExtends TabListControl
        { get { return this.Control as TabListExtends; } }
            ...
            if (host != null)
            {
                using (DesignerTransaction transaction = host.CreateTransaction(string.Format("Add TabListPage to '{0}'", control.Name)))
                {
                    try
                    {
                        ...
                        page = (TabListPageExtends)host.CreateComponent(typeof(TabListPageExtends));
