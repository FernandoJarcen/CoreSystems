...
{
    public partial class SelectGridExtends : DesignControlBase
    {
        ...
        public bool MostrarFiltro
        {
            ...
            set
            {
                ...
                if (filtro)
                {
                    ...
                    this.lbl_busca.Visible = true;
                    this.tcb_action.Visible = true;
                    this.ttb_action.Visible = true;
                    this.tbs_refresh.Visible = true;
                }
                else
                {
                    this.toolStripSeparator1.Visible = false;
                    this.lbl_busca.Visible = false;
                    this.tcb_action.Visible = false;
                    this.ttb_action.Visible = false;
                    this.tbs_refresh.Visible = false;
                }
            }
        }
        ...
        public DataTable RetornaSelecionados()
        {
            ...
            for (int indice = 1; indice < qtd + 1; indice++)
            {
                ...
                dt.Columns.Add(nome_coluna, dgv_consulta.Columns[indice].ValueType);
            }
        ...
        private string executarExcel(string mensagem)
        {
            ...
            DataTable dtExportacao = CoreService.GridToDataTable(this.dgv_consulta, false);
        ...
        private void SelectGridExtends_Load(object sender, EventArgs e)
        {
            if (validarDados())
            {
                carregarDados(query);
