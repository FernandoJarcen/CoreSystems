...
namespace CoreFramework.Controles.Controle
{
    ...
    public class TabListPageExtends : Panel
    {
        public TabListPageExtends()
        {
        ...
        [Browsable(false)]
        public TabListExtends Owner
        { get { return (TabListExtends)this.Parent; } }
        ...
        {
            if (this.Parent != null && this.Parent is TabListExtends)
